const students = [
  ...
  { name: 'Anais', nationality: 'Tajikistani', program: "Bachelor's" },
  ...
  { name: 'Dima', nationality: 'Tajikistani', program: "Bachelor's" },
  { name: 'Faisal', nationality: 'Pakistani', program: "Bachelor's" },
  { name: 'Farhan', nationality: 'Pakistani', program: "Bachelor's" },
  { name: 'Fatima', nationality: 'Tajikistani', program: "Bachelor's" },
  ...
  { name: 'Qozi', nationality: 'Tajikistani', program: "Bachelor's" },
...
students.forEach((student, index) => {
  ...
  tr.innerHTML = `<td>${index + 1}</td><td>${student.name}</td><td>${student.program}</td><td>${student.nationality}</td>`;
  rows.appendChild(tr);
});
...
function updateCost() {
  ...
  count = Math.max(1, Math.min(48, count));
